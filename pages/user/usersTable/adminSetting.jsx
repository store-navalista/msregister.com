...
export default function AdminSetting({ logging }) {
   ...
   async function updateEmailAdmin() {
      setLoading(true)
      if (
         confirm('Are you sure you want to change the admin mail?When you change your email you will be logged out!')
      ) {
   ...
   return (
      <div className={st.wrapper}>
         ...
         <form className={st.setting}>
            ...
            {isEmailChange ? (
               <div className={st.save} name='reset'>
                  <IconButton
                     disabled={loading}
                     onClick={resetForm}
                     sx={{
            ...
            <button name='password' type='button' className={st.password} onClick={(e) => changePasswordForm(e)}>
